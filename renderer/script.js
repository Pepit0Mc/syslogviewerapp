...
function testServeur(index) {
    var retour = {};
    var path = "http://" + serveurs[index]]["ip"] + serveurs[index]]["monitor"];
    fetch(path).then((res) => res.text()
        ...
        retour["warning"] = "Le " + serveurs[index]]["nom"] + " ne réponds pas<br /><br />";
...
class serveur {
     ...
     */
    loaddata() {
        this.val = testServeur(this.index);
    };
